...
exports.default = function (_db) {
  ...
  var _ref = (0, _ramdam.addIndex)(_ramdam.reduce)(function (acc, arg, i) {
    return (0, _ramdam.cond)([[_ramdam.isString, function () {
      return (0, _ramdam.isEven)(i) ? acc.collection(arg) : acc.doc(arg);
    }], [_ramdam.isNumber, function () {
      return acc.limit(arg);
    }], [_ramdam.isArray, (0, _ramdam.cond)([[(0, _ramdam.equalsLength)(3), function (arg) {
      return acc.where.apply(acc, (0, _toConsumableArray3.default)(arg));
    }], [(0, _ramdam.both)((0, _ramdam.equalsLength)(2), (0, _ramdam.compose)((0, _ramdam.includes)(_ramdam.__, ["startAt", "startAfter", "endAt", "endBefore"]), _ramdam.head)), function (arg) {
      return acc[arg[0]](arg[1]);
    }], [_ramdam.T, function (arg) {
      return acc.orderBy.apply(acc, (0, _toConsumableArray3.default)(arg));
    }]])]])(arg);
  }, db);

  var _strings = (0, _ramdam.compose)(_ramdam.length, (0, _ramdam.takeWhile)(_ramdam.isString));
  ...
  var _ops = (0, _ramdam.map)(_ramdam.curry, {
    write: function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _ref8 = (0, _ramdam.includes)(op)(["drop", "delete"]) ? _write_without_data(args) : _write(args), data = _ref8.data, ref = _ref8.ref, n = _ref8.n, query = _ref8.query;
              ...
              case 11:
                prs = (0, _ramdam.compose)((0, _ramdam.map)(function (_docs) {
                  var batch = db.batch();
                  ...
                  try {
                    for (var _iterator = (0, _getIterator3.default)(_docs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                      ...
                      if ((0, _ramdam.includes)(op)(["add", "set", "update"])) {
                        (0, _ramdam.xNil)(opt) ? batch[op](_ref9, data, opt) : batch[op](_ref9, data);
                      } else if ((0, _ramdam.includes)(op)(["drop", "delete"])) {
                        batch.delete(_ref9);
                      }
                    }
                  } catch (err) {
                  ...
                  return batch.commit();
                }), (0, _ramdam.splitEvery)(Math.min(docs.length, 500)))(docs);
                return _context2.abrupt("return", _promise2.default.all(prs));

              case 15:
                return _context2.abrupt("return", op === "delete" ? ref[op]() : (0, _ramdam.isNil)(opt) ? ref[op](data) : ref[op](data, opt));
  ...
  var getAPIs = (0, _ramdam.compose)(_ramdam.fromPairs, (0, _ramdam.map)(function (_ref18) {
    var _ref19 = (0, _slicedToArray3.default)(_ref18, 2),
        op = _ref19[0],
        flag = _ref19[1];

    return ["" + op + (0, _ramdam.toUpper)(flag), (0, _ramdam.unapply)(_ops[op](flag === "" ? "d" : flag))];
  }), _ramdam.xprod)(["get", "on", "tx"], ["", "k", "s", "r"]);

  var writeAPIs = (0, _ramdam.compose)(_ramdam.fromPairs, (0, _ramdam.map)(function (op) {
    return [op, (0, _ramdam.unapply)(_ops.write(op === "upsert" ? "set" : op, op === "upsert" ? { merge: true } : null))];
  }))(["add", "set", "update", "upsert", "delete", "drop"]);

  var ref = (0, _ramdam.unapply)(_ref);

  return (0, _ramdam.mergeAll)([getAPIs, APIs, writeAPIs, { ref: ref, firestore: db }]);
};
